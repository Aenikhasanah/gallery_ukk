...
<head>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index2.php">Halaman Foto</a>
            ...
            <td><?=$data['FotoID']?></td>
                ...
                <td>
                  ...
                  $dd = mysqli_fetch_array($ss);{
                    if($dd['status']== 0) { ?>
                    <span class=""><i><i ></i> Foto Ini bersifat private</i></span>
                    <?php } else if ($dd['status']== 1){ ?>
                      <span class=""><i><i ></i> Foto Ini bersifat dipublish untuk umum</i></span>
                      <?php  } else
                      { ?>
                      <span class=""><i><i ></i> Foto Ini bersifat dipublish untuk anggota</i></span>
                      <?php } }
                  ?>
                </td>
